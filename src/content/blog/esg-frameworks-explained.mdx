...
faq:
  - q: "Which ESG framework is mandatory?"
    a: "CSRD (the EU's Corporate Sustainability Reporting Directive) is the only mandatory framework on this list. As of 2026, it applies to companies with 1,000+ employees and €450M+ net turnover. It's reported against the ESRS standards. All other frameworks — GRI, SASB (now under ISSB), and TCFD (now under IFRS S2) — are voluntary."
  ...
  - q: "What happened to SASB?"
    a: "SASB stopped operating as a standalone standard-setter in August 2022 when the IFRS Foundation consolidated it into the ISSB. SASB Standards still exist and are actively used — but as industry-specific guidance under IFRS S1, not as an independently maintained framework."
  ...
  - q: "What is double materiality in ESG reporting?"
    a: "Double materiality means reporting on both how sustainability issues affect the company financially (financial materiality) and how the company affects people and the environment (impact materiality). CSRD requires double materiality reporting."
featured: false
---
